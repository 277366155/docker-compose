...
-- 这里的逻辑就要修改了，优先匹配header，再IP
local default, stage = ...
-- ngx.log(ngx.ERR, "default is ", default, "stage is ", stage)
local ngx_dic = ngx.shared.tenantids
local shop_id = get_header("tenantid")
--ngx.log(ngx.ERR, "Request tenantid is ", shop_id, "---\n")
local result = ngx_dic:get(shop_id)
